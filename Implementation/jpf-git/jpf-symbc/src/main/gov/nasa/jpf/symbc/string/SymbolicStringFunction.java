...
public class SymbolicStringFunction  extends StringSymbolic implements SymbolicFunction
{
    String class_name;
    String method_name;
    ...
    public SymbolicStringFunction (String cls, String mth, Class<?>[] ast,
    ...
    public String stringPC () {
        ...
        return  method_name + "_SYMSTRING(" + result + ")";
    }
