...
public class SymbolicRealFunction implements Expression {
    public String name;
    public Expression[] args;

    public SymbolicRealFunction(String name, Expression[] args) {
        this.name = name;
        this.args = args;
    }
    ...
    public boolean equals(Object o) {
        ...
        SymbolicRealFunction that = (SymbolicRealFunction) o;
