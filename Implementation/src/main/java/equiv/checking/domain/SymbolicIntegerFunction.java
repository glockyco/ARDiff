...
public class SymbolicIntegerFunction implements Expression {
    public String name;
    public Expression[] args;

    public SymbolicIntegerFunction(String name, Expression[] args) {
        this.name = name;
        this.args = args;
    }
    ...
    public boolean equals(Object o) {
        ...
        SymbolicIntegerFunction that = (SymbolicIntegerFunction) o;
